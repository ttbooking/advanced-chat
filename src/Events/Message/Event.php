...
namespace TTBooking\AdvancedChat\Events\Message;
...
abstract class Event implements ShouldBroadcast
{
    ...
    {
        return new PresenceChannel('advanced-chat.room.'.$this->message->room_id);
    }
    ...
    {
        return ['advanced-chat', 'room:'.$this->message->room_id, 'message:'.$this->message->getKey()];
    }
}
