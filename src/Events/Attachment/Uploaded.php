...
namespace TTBooking\AdvancedChat\Events\Attachment;
...
class Uploaded implements ShouldBroadcastNow
{
    ...
    {
        return new PresenceChannel('advanced-chat.room.'.$this->attachment->message->room_id);
    }
    ...
    {
        return ['advanced-chat', 'room:'.$this->attachment->message->room_id, 'message:'.$this->attachment->message->getKey()];
    }
}
