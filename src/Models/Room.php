...
use TTBooking\AdvancedChat\Database\Factories\RoomFactory;
use TTBooking\AdvancedChat\Http\Resources\RoomResource;
use TTBooking\AdvancedChat\Models\Scopes\ParticipantScope;
use TTBooking\AdvancedChat\Observers\RoomObserver;
use TTBooking\AdvancedChat\Policies\RoomPolicy;
...
class Room extends Model
{
    ...
    {
        /** @var int */
        return config('advanced-chat.nanoid_size_rooms') ?: $this->nanoidSize ?? 21;
    }
    ...
    {
        return $this->belongsTo(AdvancedChat::userModel(), 'created_by');
    }
    ...
    {
        return $this->belongsToMany(AdvancedChat::userModel(), 'chat_participants')
    ...
    {
        $nameKey = config('advanced-chat.user_name_key');
        $credKey = config('advanced-chat.user_cred_key');
