...
use TTBooking\AdvancedChat\Database\Factories\MessageFactory;
use TTBooking\AdvancedChat\Enums\MessageState;
use TTBooking\AdvancedChat\Http\Resources\MessageResource;
use TTBooking\AdvancedChat\Observers\MessageObserver;
use TTBooking\AdvancedChat\Policies\MessagePolicy;
...
class Message extends Model
{
    ...
    {
        /** @var int */
        return config('advanced-chat.nanoid_size_messages') ?: $this->nanoidSize ?? 21;
    }
    ...
    {
        return $this->belongsTo(AdvancedChat::userModel(), 'sent_by');
    }
